                ...
                <div class="car_info_container">
                    <div class="car_info">
                        ...
                        <div class="info_item2">
                            ...
                            <p><span class="bold">Desde: </span><span>{{substr($historico->uberActual->fechaInicio,0,10)}}</span></p>
                        </div>
                    </div>
                </div> 
            </section>
                    ...
                    <div class="historicocar_info_container">
                        <div class="car_info">
                            <div class="info_item1">
                                ...
                                <p><span class="bold">Desde: </span><span>{{substr($histoUber->fechaInicio,0,10)}}</span></p>
                                <p><span class="bold">Hasta: </span><span>{{substr($histoUber->fechaFinal,0,10)}}</span></p>
                            </div>
                        </div>
                    </div> 
                </section>           
